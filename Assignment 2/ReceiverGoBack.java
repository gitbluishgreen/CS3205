...
class ReceiverGoBack
{
    public static void main(String[] args)
    {
        String cur_arg;
        ReceiverGoBackHelper obj = new ReceiverGoBackHelper();
        int p = 0;
        int l = args.length;
        while(p < l)
        {
    ...
    { 
        ...
        { 
            ...
            while(received_packets.size() < max_packets)
            {
                ...
                socket.setSoTimeout(5000);//at most one second
                //pw.println("Listening!");
                try
                {
